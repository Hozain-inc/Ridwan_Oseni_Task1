## Task 1 favourite Quote 
# favourite_quote = input("Enter your favorite quote: ")
# favourite_quote = favourite_quote.title()
# print(f"\"{favourite_quote}\"")

# # Task 2
# shopping_list = []
# item_1 = input("input the first item") 
# shopping_list.append(item_1)
# item_2 = input("input the second item") 
# shopping_list.append(item_2)
# item_3 = input("input the third item") 
